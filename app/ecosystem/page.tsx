...
const PARTNER_DESCRIPTIONS: Record<string, string> = {
  ...
  "Tokeniser": "Redbelly's native equity tokenisation registry with 150+ companies and 20,000 investors representing $1B+ in equities on-platform. Formerly known as Liquidise, Tokeniser has launched an asset tokenisation solution on Redbelly Mainnet to tokenise over $800M in unlisted private equity, giving investors tools to unlock liquidity for previously illiquid holdings.",
